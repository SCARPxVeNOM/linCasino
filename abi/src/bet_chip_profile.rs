    ...
    pub fn calculate_bet_data(&mut self) {
        ...
        let generated_chip_list = [
            Chip {
                ...
                text: format_chip_units(denominations[0].saturating_div(1u128).into()),
                enable: denominations[0] <= self.balance,
            },
            Chip {
                amount: denominations[1],
                text: format_chip_units(denominations[1].saturating_div(1u128).into()),
                enable: denominations[1] <= self.balance,
            },
            Chip {
                amount: denominations[2],
                text: format_chip_units(denominations[2].saturating_div(1u128).into()),
                enable: denominations[2] <= self.balance,
            },
            Chip {
                amount: denominations[3],
                text: format_chip_units(denominations[3].saturating_div(1u128).into()),
                enable: denominations[3] <= self.balance,
            },
            Chip {
                amount: denominations[4],
                text: format_chip_units(denominations[4].saturating_div(1u128).into()),
